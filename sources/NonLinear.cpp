...
double nl_idic::sound_speed_asterisk(Cell * cell)
{
    ...
    return sqrt(Params::get_instance().gamma) * result;
...
double nl_idic::t_stop_asterisk(Cell * cell)
{
    ...
    {
        result = 8. / 3. * 24. * a * particle_density * Re_astr / gas_density_astr / vel_ratio;
    }
    else if(Re_astr <= 800)
    {
        result = 8. / 3. * 24. * 4. * a / lambda_astr * a * particle_density / c_s_astr / gas_density_astr;
                //particle_density * pow(Re_astr, 0.6) / gas_density_astr / vel_ratio;
    }
    else if(Re_astr > 800)
    {
